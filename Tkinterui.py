# Tkinterui.py
"""
This module holds the functions to display the UI for allowing users to select the board configuration and number of games.
It also holds the UI for rendering the simulation for the 2 competing agents and displaying the final result.
"""
...
class gameGrid():
    """
    Object with the game grid. It will hold all the functions for setting up the hex grid and moving the nodes to the 
    ...
    def __init__(self, name1, name2, keyFrame, gameFrame, resultFrame,mode, gridSize):
        ...
        @:param name1 - to indicate the name of the first player
        @:param name2 - to indicate the name of the second player
        @:param keyFrame - to indicate the frame for holding the keys
        @:param gameFrame - to indicate the frame for displaying the game grid
        @:param resultFrame - to indicate the frame for holding the individual result
        @:param mode - the current player starting the game
        @:param gridSize - the size of the grid
        """
        self.gameFrame = gameFrame
        self.mode = mode 

        #initialize all the 3 frames
